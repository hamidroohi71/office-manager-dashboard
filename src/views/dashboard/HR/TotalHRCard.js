          ...
          <Box sx={{ p: 2.25 }}>
            <Grid container direction="column">
              ...
              <Grid item sx={{ mt: 3, zIndex: 100 }}>
                <Typography sx={{ fontSize: '1rem', fontWeight: 700 }}>All Employees:</Typography>
              </Grid>
              <Grid container direction="column" sx={{ mt: 3, gap: 2 }}>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Technical team members:</Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Marketing team members:</Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Financial team members:</Typography>
                    </Grid>
                    <Grid item>
...
TotalHRCard.propTypes = {
  isLoading: PropTypes.bool
};

export default TotalHRCard;
