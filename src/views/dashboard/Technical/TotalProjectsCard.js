...
const TotalProjectCard = ({ isLoading }) => {
          ...
          <Box sx={{ p: 2.25 }}>
            <Grid container direction="column">
              ...
              <Grid item sx={{ mt: 3, zIndex: 100 }}>
                <Typography sx={{ fontSize: '1rem', fontWeight: 700 }}>All Projects at a glance</Typography>
              </Grid>
              <Grid container direction="column" sx={{ mt: 3, gap: 2 }}>
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of Active projects:</Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of projects in Successful Zone: </Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of projects in normal Zone: </Typography>
                    </Grid>
                    <Grid item>
                      <Typography>2</Typography>
                    </Grid>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of projects in dangerous Zone: </Typography>
                    </Grid>
                    <Grid item>
