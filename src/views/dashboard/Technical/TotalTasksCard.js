...
const TotalTasksCard = ({ isLoading }) => {
              ...
              <Grid container direction="column" sx={{ mt: 3, gap: 2 }}>
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of Open tasks:</Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of done tasks: </Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of test required tasks:</Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Number of failed tasks: </Typography>
                    </Grid>
                    <Grid item>
