          ...
          <Box sx={{ p: 2.25 }}>
            <Grid container direction="column">
              ...
              <Grid item sx={{ mt: 3, zIndex: 100 }}>
                <Typography sx={{ fontSize: '1rem', fontWeight: 700 }}>Debts and Credits:</Typography>
              </Grid>
              <Grid container direction="column" sx={{ mt: 3, gap: 2 }}>
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Debts amount:</Typography>
                    </Grid>
                    <Grid item>
                      <Typography>40,000,000 T</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item sx={{ zIndex: 100 }}>
                  <Grid container justifyContent="space-between" sx={{ gap: '3rem' }}>
                    <Grid item>
                      <Typography>Credits Amount:</Typography>
                    </Grid>
                    <Grid item>
                      <Typography>60,000,000 T</Typography>
                    </Grid>
                  </Grid>
                </Grid>
              </Grid>
...
DebtsCredits.propTypes = {
  isLoading: PropTypes.bool
};

export default DebtsCredits;
